      ...
      <?php while ( have_rows('footer') ) : the_row();
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-sm-4">
            ...
            <a href="https://www.facebook.com/VillaKalma" class="social-links" target="_blank">
            ...
            <a href="https://www.instagram.com/villakalma/" class="social-links" target="_blank">
          ...
          <div class="col-xs-6 col-sm-4"><?php the_sub_field('column_3'); ?></div>
        </div>
