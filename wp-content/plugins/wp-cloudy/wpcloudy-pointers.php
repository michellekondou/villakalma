...
function wpc_pointer_print_scripts() {
	...
	$pointer_content .= "<p>".__('<strong>Before starting:</strong> enter your own OpenWeatherMap API key in','wp-cloudy')." <a href=\'".get_bloginfo('url')."/wp-admin/options-general.php?page=wpc-settings-admin#tab_advanced\'>". __('Advanced Settings!','wp-cloudy')."</a></p>";
	?>
